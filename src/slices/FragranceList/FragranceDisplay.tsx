...
// Use a generic document type for now
...
export const FragranceDisplay = async ({ id }: FragranceDisplayProps) => {
  ...
  const fragrance = await client.getByID<FragranceDocument>(id);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <FragranceAttributes
          scentProfile={fragrance.data.scent_profile as "spicy" | "woody" | "fresh"}
          mood={fragrance.data.mood as "bold" | "grounded" | "refreshing"}
          className="mb-10"
        />
